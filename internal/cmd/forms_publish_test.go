...
func TestExecute_FormsPublish_JSON(t *testing.T) {
	...
	// Replace formsSetPublishSettings to use the httptest server's client.
	formsSetPublishSettings = makeTestFormsSetPublishSettings(srv)
...
func TestExecute_FormsPublish_DryRun_JSON(t *testing.T) {
	...
	formsSetPublishSettings = func(context.Context, *formsapi.Service, string, bool, bool) (*formsPublishSettingsResult, error) {
...
// makeTestFormsSetPublishSettings creates a formsSetPublishSettings function
// that uses the httptest server's HTTP client and endpoint for testing.
func makeTestFormsSetPublishSettings(srv *httptest.Server) func(ctx context.Context, svc *formsapi.Service, formID string, publishAsTemplate, requireAuth bool) (*formsPublishSettingsResult, error) {
	return func(ctx context.Context, svc *formsapi.Service, formID string, publishAsTemplate, requireAuth bool) (*formsPublishSettingsResult, error) {
		body := map[string]any{
			"publishSettings": map[string]any{
