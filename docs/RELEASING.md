...
- `version "X.Y.Z"`
- `url "https://github.com/namastexlabs/gog-cli/archive/refs/tags/vX.Y.Z.tar.gz"`
- `sha256 "<sha256>"`
- `depends_on "go" => :build`
- Build:
...
```sh
curl -L -o /tmp/gogcli.tar.gz https://github.com/namastexlabs/gog-cli/archive/refs/tags/vX.Y.Z.tar.gz
