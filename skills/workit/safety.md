...
- Example:
  - `wk drive ls --read-only`
  - `wk gmail search 'from:billing newer_than:30d' --read-only`
...
- Example:
  - `wk gmail send --to user@acme.com --subject "Hello" --body "Test" --dry-run`
