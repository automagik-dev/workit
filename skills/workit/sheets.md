...
## Examples
```bash
wk sheets get <sheetId> 'Summary!A1:C20' --read-only --json
wk sheets update <sheetId> 'Summary!A1:C1' 'Week' 'Revenue' 'Delta' --dry-run
```